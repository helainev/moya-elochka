...
if __name__ == "__main__":
    ...
    #text_command = "Добавь в каталог карточку. Название: 'Игрушка 4', статус: 'доступно для заказа', изображение: img/elochka4.jpg. Описание придумай сам." 
    #text_command = "Добавь в каталог карточку. Название: 'Игрушка 5', статус: 'доступно для заказа', изображение: img/elochka5.jpg. Описание придумай сам." 
    ...
    text_command = "Ко всем игрушкам 1 - 8 сдела так чтобы при нажатии кнопки Заказать должно открытся меню на выбор каким образом заказать: или через телеграмм или через vk или через instagramm" 
