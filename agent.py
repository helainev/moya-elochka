...
if __name__ == "__main__":
    ...
    text_command = "При нажатии каждой кнопки Заказать (всего 8 кнопок) должно открытся меню на выбор каким образом заказать: или через телеграмм или через vk или через instagramm" 
